...
$xMarcador =  "-963965.3702419729"; //$_GET["xMarcador"];

$yMarcador = "4958857.895348617" ;//$_GET["yMarcador"];

//pontos de interesse
$xPontosInteresse = "-963348.482191776";//$_GET["xPontosInteresse"];
$yPontosInteresse = "4958470.241593376";//$_GET["yPontosInteresse"];
